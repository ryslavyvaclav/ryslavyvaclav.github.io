...
if ( ! class_exists( 'SAAS_Software_Technology_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class SAAS_Software_Technology_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new SAAS_Software_Technology_WPTT_WebFont_Loader( $url );
