                            ...
                            <div class="comment-meta">
                                <a href="<?php echo esc_url(get_comment_link($comment->comment_ID)); ?>">
                                    <time datetime="<?php comment_time('c'); ?>">
                                        <?php /* translators: %s: Date */ printf( esc_attr('%1$s at %2$s', '1: date, 2: time', 'web-designer-elementor'), esc_attr( get_comment_date() ), esc_attr( get_comment_time() ) ); ?>
                                    </time>
                                </a>
...
function web_designer_elementor_max_title_length( $title ) {
	$max = 20;
	if( strlen( $title ) > $max ) {
...
add_filter( 'the_title', 'web_designer_elementor_max_title_length');
