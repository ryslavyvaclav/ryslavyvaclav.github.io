...
/* harmony export */   "initDarkModeSwitch": function() { return /* binding */ initDarkModeSwitch; }
/* harmony export */ });
/**
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "masonryInit": function() { return /* binding */ masonryInit; }
/* harmony export */ });
/**
 * Copyright 2020 Google LLC
 *
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "COLOR_MODES": function() { return /* binding */ COLOR_MODES; }
/* harmony export */ });
...
/* harmony import */ var _front_end_components_dark_mode_switch__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../front-end/components/dark-mode-switch */ "./theme/assets/src/front-end/components/dark-mode-switch.js");
/**
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
(function ($) {
  ...
  Object.keys(materialDesignThemeColorControls).forEach(control => {
    api(control, value => value.bind(() => generatePreviewStyles(materialDesignThemeColorControls)));
  });

  if (materialDesignThemeColorControlsDark) {
    Object.keys(materialDesignThemeColorControlsDark).forEach(control => {
      api(control, value => value.bind(() => generatePreviewStyles(materialDesignThemeColorControlsDark)));
    });
  }
  ...
  const generatePreviewStyles = selectedControls => {
    ...
    let stylesheet = $('#' + stylesheetID),
        styles = '',
        darkStyles = '',
        lightStyles = ''; // If the stylesheet doesn't exist, create it and append it to <head>.
  ...
  const updateColorMode = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.debounce)(mode => {
    ...
    if ('dark' === mode) {
      switcherIcon.innerText = _front_end_components_dark_mode_switch__WEBPACK_IMPORTED_MODULE_2__.ICONS.LIGHT_MODE;
    } else {
      switcherIcon.innerText = _front_end_components_dark_mode_switch__WEBPACK_IMPORTED_MODULE_2__.ICONS.DARK_MODE;
    }
  }, 300);

  const hexToRgb = hex => !hex ? [] : hex.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, (m, r, g, b) => '#' + r + r + g + g + b + b).substring(1).match(/.{2}/g).map(x => parseInt(x, 16));
